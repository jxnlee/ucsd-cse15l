...
![Image](assets/fictional_map.png)
...
brief description and a screenshot. Your job is to _reproduce_ the error shown
...
1. **Write down in notes**: Discuss and confirm with your partner – what is the
   **desired** or **expected** behavior, and which part of the output is wrong or
   not what's expected?
1. Reproduce this behavior with your partner. If you have to, take the time to
   ...
   the same command.
1. **Write down in notes**: Take a screenshot of your reproduction and put it in
...
1. **Write down in notes**: Describe how to change the commands or program to get
...
1. **Write down in notes**: Have you ever made this mistake before? What was easy
...
![Image](assets/run-java-not-class.png)
...
![Image](assets/2023-03-03-15-33-10.png)

## Scenario 4

A project has the following file layout:

![Image](assets/2023-03-03-15-41-10.png)
...
![Image](assets/2023-03-03-15-41-25.png)
